...
import { JsonObj, EventObj } from 'types/Generic';

export type Summary1ModalProps = {
  open: boolean;
  handleClose: () => void;
  modalData: JsonObj;
  reset: () => void;
    ...
    <Modal {...{ open, handleClose }}>
      <Grid item>
        <Typography variant="h5">
          Summary 1 {val.dewey_summary_id && `(${val.dewey_summary_id})`}
        </Typography>
      </Grid>
      <Grid item>
        <TextField
          fullWidth
          label="Summary Id"
          value={val.summary_id || ''}
          onChange={handleOnChange('summary_id')}
        ></TextField>
      </Grid>
      <Grid item>
        <TextField
